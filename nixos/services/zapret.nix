...
in
{
  services.zapret = {
    ...
    udpPorts = [
      ...
      params = [
        # --wf-tcp=80,443,853,2053,2083,2087,2096,8443,%GameFilter%
        # --wf-udp=443,1400,3478-3482,3484,3488,3489,3491-3493,3495-3497,19294-19344,50000-50032,%GameFilter%,0-65535 ^

        "--comment Telegram (WebRTC)"
        "--filter-udp=1400"
        "--filter-l7=stun"
        "--dpi-desync=fake"
        ...
        "--dpi-desync=fake"
        "--dpi-desync-fake-tls-mod=rnd,dupsid,sni=yandex.ru"
        "--dpi-desync-repeats=6"
        "--dpi-desync-fooling=badseq"
        "--dpi-desync-badseq-increment=0"
        "--new"
        ...
        "--hostlist=${zdy}/lists/list-general.txt"
        "--hostlist-domains=adguard.com,adguard-vpn.com,totallyacdn.com,whiskergalaxy.com,windscribe.com,windscribe.net,cloudflareclient.com,soundcloud.com,sndcdn.com,soundcloud.cloud,nexusmods.com,nexus-cdn.com,prostovpn.org,html-classic.itch.zone,speedtest.net,softportal.com,githubusercontent.com,githubassets.com"
        "--dpi-desync=fake,multisplit"
        "--dpi-desync-fake-tls-mod=rnd,dupsid,sni=yandex.ru"
        ...
        # "--ipset=${zdy}/lists/ipset-all.txt"
        # "--dpi-desync=syndata,fake,fakedsplit"
